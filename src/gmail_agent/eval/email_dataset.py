...
response_criteria_list = [
    ...
    response_criteria_9, response_criteria_10, response_criteria_11, response_criteria_12,
    response_criteria_13, response_criteria_14, response_criteria_15, response_criteria_16,
]
...
expected_tool_calls = [
    ["write_email", "done"],                                                        # 1: API docs
    [],                                                                             # 2: Newsletter - ignore
    [],                                                                             # 3: Maintenance - notify only
    ["check_calendar_availability", "schedule_meeting", "write_email", "done"],    # 4: Tax call
    [],                                                                             # 5: Expense report - notify
    ["write_email", "done"],                                                        # 6: Conference invite
    ["write_email", "done"],                                                        # 7: Doc review
    ["write_email", "done"],                                                        # 8: Swimming class
    [],                                                                             # 9: GitHub PR - notify
    ["check_calendar_availability", "write_email", "done"],                        # 10: Planning meeting
    [],                                                                             # 11: AWS alert - notify
    [],                                                                             # 12: Subscription renewal - notify
    ["write_email", "done"],                                                        # 13: Doctor reminder
    [],                                                                             # 14: Social media - ignore
    ["check_calendar_availability", "schedule_meeting", "write_email", "done"],    # 15: Joint presentation
    [],                                                                             # 16: OpenAI newsletter - notify
]
